...
<a class="logout-link nav-link" href="/logout" role="button">
    <button class="logout-btn bg-danger text-white py-10 px-5 border-0">LOGOUT</button>
</a>
@endsection
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">SE CAMP {{session("key")}} : {{Auth::user()}}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
